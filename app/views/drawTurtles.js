...
YUI.add('drawTurtles', function (Y) {
	...
	Y.drawTurtles = function (canvas, config, gridSize) {
		...
		var fetchImage = function (file) {
			...
			src[file].onerror = function () {
				//alert('Error!!!');
				//TODO Do something if file can't be found
			};

			src[file].src = 'app/assets/images/' + file;
		};
